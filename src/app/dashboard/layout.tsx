        ...
        `}
            ...
            >
                ...
                <nav className="flex flex-col gap-2">
                    <Link href="/dashboard" className="hover:bg-blue-100 rounded px-3 py-2 font-medium transition" onClick={()=>setSidebarOpen(false)}>Home</Link>
                    <Link href="/dashboard/analytics" className="hover:bg-blue-100 rounded px-3 py-2 font-medium transition" onClick={()=>setSidebarOpen(false)}>Analytics</Link>
                    <Link href="/dashboard/settings" className="hover:bg-blue-100 rounded px-3 py-2 font-medium transition" onClick={()=>setSidebarOpen(false)}>Settings</Link>
                </nav>
            </aside>
